        ...
        <div style={{ 
          ...
          {user?.profile?.profilePicture && (
            <div style={{
              ...
              <img 
                src={`https://job-portal-of27.onrender.com/uploads/${user.profile.profilePicture.split('/').pop()}`} 
                alt="Profile" 
                style={{ 
                  width: '140px',
                  height: '140px',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                ...
                <div>
                  ...
                  <a
                    href={`https://job-portal-of27.onrender.com/uploads/${user.profile.resume.split('/').pop()}`}
                    target="_blank"
